...
import checkIcon from "../../../img/login/modal/check.svg";
...
export const ChekboxSquare = styled.span`
  ...
  width: 16px;
  height: 15px;
  border: 1px solid ${(p) => p.theme.colors.bordeFontrColor};
...
export const Button = styled.a`
  ...
  box-shadow: inset 0 0 0 1px ${(p) => (p.active ? p.theme.colors.thirdTextColor : p.theme.colors.primaryTextColor)};
  color: ${(p) => (p.active ? p.theme.colors.fourthTextColor : p.theme.colors.primaryTextColor)};
  ...
  text-align: center;
  cursor: pointer;
  background-color: ${(p) => (p.active ? p.theme.colors.secondTextColor : p.theme.colors.fourthTextColor)};
  &:hover {
